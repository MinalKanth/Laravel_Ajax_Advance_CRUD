...
<div class="container mt-2">
        ...
        <form id="form">
            ...
            <div class="form-group mb-3">
                ...
                <div>
                    ...
                    <button type="submit" id="submitBtn2" class="btn btn-info  btn-sm">Add (Temporarily)</button>
                    {{--  This save button is not working . Need to fix this tomorrow.  --}}
    ...
    <div class="container mt-5">
        <table class="table table-striped table-bordered table-hover" id="dataTables-example" border="2">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Dob</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        submitBtn.addEventListener('click', (event) => {
            ...
            //dt.row().data([name, dob, des, qua, email, mo, gender, loc, country, state, city]).draw(false);
            dt2.rows.add([
                [name, dob, des, qua, email, mo, gender, loc, country, state, city]
            ]).draw();
            $("#name,#dob,#des,#qua,#email,#mo,#country,#state,#city").val('');
        ...
        let dt2 = $('#dataTables-example').DataTable();
